...
export const uiTranslations = {
  ...
  login: {
    ...
    rateLimited: "⏳ Please wait 15 seconds before resending an email",
    importSession: "🔄 Import session from production",
    ...
    logout: "Log out",
    connectToCloud: "Connect to save online",

...
export const uiTranslations = {
  ...
  login: {
    ...
    checkEmail: "✉️ Controlla la tua email! Un link di accesso è stato inviato.",
  ...
  treasures: {
    ...
    emmanuelMessage: "Sei arrivato in cima alla montagna, e la conoscenza è acquisita. Ma la fede incrollabile richiede esperienza di vita, misericordia e vero amore di Gesù. Le varie prove della vita metteranno alla prova il tuo cammino, il vero percorso che scegliamo, il nostro cuore. Rimaniamo imperfetti, i nostri desideri sono numerosi, e l'amore per il guadagno o per il nostro comfort personale diventa troppo spesso la nostra priorità egoistica. Chiedi a Dio saggezza, il suo amore, la sua forza, e riconosci umilmente le tue debolezze, perché nulla può essere nascosto a Lui... Nulla. Non c'è bisogno di navigare in modalità privata, usare VPN, o persino cancellare la cronologia. Digiuna come Daniele: privati per un momento di ciò che ami di più, nella calma e nella saggezza. Questo ti permetterà di ascoltare meglio Dio, di avere una disposizione del cuore pronta per trasformazioni profonde - e spesso dolorose. Allora i sogni e le visioni diventeranno più chiari, come per Giuseppe. Ma guardati dall'orgoglio: non cedere a 'Ho sempre ragione' o 'Lo so meglio'. Perché la rivelazione di Dio è una grazia straordinaria. Non diventare un dottore della Legge, capace di crocifiggere Gesù di nuovo oggi, Lui che chiede semplicemente di amare il tuo prossimo... e concedere loro la stessa libertà che ricevi. Avere fede significa entrare in una relazione libera e un viaggio del cuore. Ti renderà eroi potenti, capaci dell'impossibile. Perché l'esperienza del soprannaturale, la presenza di Dio, la sua conferma o benedizione ti renderà veramente incrollabile.",
  ...
  quotes: {
    wisdom: "Il timore del Signore è l'inizio della saggezza",
    faith: "Tutto posso in colui che mi fortifica",
    hope: "Il Signore è il mio pastore, nulla mi mancherà",
  ...
  philosophy: {
    ...
    jesusEmphasizes: "Quando Gesù dà un nuovo comandamento, enfatizza il verbo amare",
  ...
  endCredits: {
    lines: [
      ...
      { text: "Mostrano ciò che è importante", delay: 2000 },

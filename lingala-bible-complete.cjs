...
// ============================================================================
// Tous les 57 versets extraits et traduits
...
module.exports = {
  "chapters": {
    ...
    "2": {
      "title": "Libala na Kana",
      "verses": [
        "Mpe na mokolo ya misato ezalaki na libala na Kana ya Galile; mpe mama ya Yesu azalaki kuna."
      ]
    },
    "3": {
      "title": "Yesu mpe Nikodemo",
      "verses": [
        "Ezalaki na moto moko ya Bafarisai, nkombo na ye Nikodemo, mokonzi ya Bayuda."
      ]
    },
    "4": {
